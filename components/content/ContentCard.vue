...
<template>
  <div
    class="px-4 py-4 pt-5 flex-1"
    border="~ base rounded-lg hover:primary"
    min-w-80 block relative
    :class="wip ? 'op75 pointer-events-none' : ''"
  >
    <span class="text-lg text-primary mb-3 inline-flex h-7 w-7 pointer-events-none items-center" :class="icon" />
