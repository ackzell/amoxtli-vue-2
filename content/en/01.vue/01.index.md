...
[Vue 3](https://vuejs.org/) is a progressive framework for building user interfaces. In this section, we will cover the basics of Vue.
...
You can use Vue SFC to build your application. You'll be able to use `ref`, `computed` and other Vue APIs to create interactive components.
